...
<input type="radio" name="hub1" class="input_radio " required>Male
</label>&nbsp;
<label class="radio form-inline">
<input type="radio" name="hub1" class="input_radio " required>
Female
</label>
</div>
...
<input type="text" class="input-block-level f_name padding2 span12" placeholder="Email / User Name" required >
<input type="text" class="input-block-level l_name padding2 span12" placeholder="Password" required >
</div>
<div><a href="account_recovery">Can't access your account?</a><br></div>
<div class="hh_cbbox">
...
<map name="Map">
<area shape="rect" coords="1,3,128,40" href="http://www.facebook.com" target="_blank" alt="Facebook Sign Up">
